...
function App() {
  ...
  <div className='container1'>
    <Routes>
        ...
        <Route path= "/Edit" element={<Sample><Edit /> </Sample>} />
        <Route path= "/Start" element={<Sample><Start /> </Sample>} />
        <Route path= "/Reset" element={<Sample><Reset /> </Sample>} />
        <Route path= "/Logo" element={<Sample><Logo /> </Sample>} />
